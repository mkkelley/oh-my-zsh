...
@curl -L https://raw.github.com/mkkelley/oh-my-zsh/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/mkkelley/oh-my-zsh/master/tools/install.sh -O - | sh@
